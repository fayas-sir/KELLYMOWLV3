...
const array = ['Akhil','Aliya','Aliyo','alive','alone','Althaf','Ameer','ano','ara','Ardra','ayilla','ayn','aysheri','Ayyo','baby','Back','bad boy','Bad','bgm','Bgm','Bhasi','bie','big fan','Blackzue','Boss','bot','Bot','Bro','broken','brokenlove','Bye','care','Chathi','chatho','Chathy','Chetta','Chiri','Chunk','chunke','chunks','comedy','cr7','Cr7','Cristiano','Cry','da','Da','Dai','DD','die','Dora','Eda','ee','ekk','Ellarum ede','ennitt','enth','Entha cheyya','entha','Enthada','evde','fayas','fayassir','Fan','Fayassir','fd','Feel aayi','Fek','ff','foodadi','Friends','free','Foodadi','fresh','friends','Frnd','Fuck','Fsq','Gd mng','gd n8','git','Gd ngt','Gouri','gdmng','gdngt','good bye','gouri','group','grp','Ha','hate','hi','help','https','Haters','Hbd','Hbday','He','Hello','Hello','Hi','Hi','Hlo','Hloo','Hoi','Hy','i am back','Invite','Ikka','ijathi','invite','kellymowl','jd','kadhal','kali','Kanapi','Kellymowl','Kanaran','Kanjan','Kanjav','kar98','Kemam','kenzo','Kenzoo','kerivaa','Kevin','Kgf','killadi','king','kiss','Kk','Koi','kozhi','Kukku','kundan','Kundan','Kunju','kunna','Kurup','Kutty','La be','Lala','left','Legend','Leopucha','life','line','Lo','Loo','Love tune','love u','Loveyouda','Love','lover','loverundo','loveyouda','Loveu','Lub u','lucifer','machan','Mad','Malang','mindalle','mindathe','Mohanlal','Mood','Muslimsong','moodesh','moonji','Music pranthan','music','muslimsong','Muth','muthe','my area','My god','My love','Myr','mybos','mylove','myr','myre','Nalla kutty','Nallakutti','nallath','Name entha','Name','nanban','Nanbiye','Nandhutty','Nanni','neymar','Neymar','Neymer','Nirthada','nirthada','Nirtheda','Nishal','njan','Njn vera','njn','Njr','noob','Oh no','Oh','ok bei','Ok bye','ok da','ok','oombi','oompi','owner','over','owner','Paat','paatt','Paavam','padicho','pani','Panni','parayatte','patti','perfect ok','Pever','pewer','photo','Pikachu','Pinnallah','Place','Poda','Podai','Poli','polika','Pooda','poora','Poote','Pora','Potta','Potte','Power varate','power','Poweresh','Power','Poyeda','Pranayam','Psycho','Ramos','rascal','rashmika','rasool','return','rider','remove','Rose','sad','Sad','Sahva','saji','Sayip','scene','Sed aayi','Messi','messi','sed bgm','Sed tune','sed','Sed','Senior','Serious','set aano','Set','Seth po','Singapenne','single','sis','song','sketched','Smile','sneham','Soldier','sorry','Sry','Save','Subscribe','Suhail','sulthan','Super','T','Tentacion','Thalapathy','thall','thamasha','Thantha','thayoli','theri','thot','thottu','thug','Thyr','Town','Track maat','trance','Uff','Umbi','umma','uyir','Va','Vaa','vada','Vava','Veeran','venda','verithanam','Vidhi','Wait','waiting','welcome','wizard','why','wow','xxx','Yaar','Yt','Z aayi','2','aara','Abhiram','Aarulle','adi','adima','Achu','Adipoli','Ajmal Achu','Ajmal','breakup','Chunks','Clg','dance','delete','Di','don','Ee','enjoy','Fen','Gd','Hacker','I love you','Kali','Kenzo','Kk gaming','KL LUTTAP 007','Kl luttapi 007','kozhi','lair','love','Men','Mm','myr','Myre','Nanbaa','nanban','Nirth','Njan vannu','Njan','No love','paatt','Penn','Pinnalla','poda','Pooda','prandh','putt','Rashmika','Rashu fans','Rashu','Ringtone','rip','Sarassu','Sarasu','Sed','Set aaka','Sfi','shibil','Single','sopnam','Tholvi','Uyr','Waiting','wcm']
array.map( async (a) => {
